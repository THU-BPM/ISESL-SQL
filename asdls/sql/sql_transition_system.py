...
from asdls.sql.parser.parser_base import Parser
from asdls.sql.unparser.unparser_base import UnParser
from asdls.asdl import ASDLGrammar
from asdls.asdl_ast import RealizedField, AbstractSyntaxTree
from asdls.transition_system import GenTokenAction, TransitionSystem, ApplyRuleAction, ReduceAction
...
if __name__ == '__main__':
    ...
    grammar = ASDLGrammar.from_filepath('asdls/sql/grammar/sql_asdl_v2.txt')
