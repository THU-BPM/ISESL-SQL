...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--toy', action='store_true', help='whether generate small dataset')
    arg_parser.add_argument('--semantic_graph', action='store_true', help='generate semantic edge')
